...
final communityFeedProvider = FutureProvider.family<List<CommunityPost>, RegionBoard>((ref, key) {
  final repo = ref.watch(communityRepositoryProvider);
  return repo.getPosts(key.region, board: key.board);
});

/// 홈 화면 "커뮤니티 새 소식" 미리보기용 — 추억 게시판 최근 3개만.
final communityPreviewProvider = FutureProvider.family<List<CommunityPost>, String>((ref, region) {
  final repo = ref.watch(communityRepositoryProvider);
